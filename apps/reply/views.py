...
def delete_reply(reply_id):
    ...
    try:
        ...
        from apps.notification.models import Notification, NotificationItemType

        Notification.query.filter_by(
            item_type=NotificationItemType.REPLY, item_id=reply_id
        ).delete()
        ...
        for child in child_replies:
            # 각 대댓글의 알림도 삭제
            Notification.query.filter_by(
                item_type=NotificationItemType.REPLY, item_id=child.reply_id
            ).delete()
