...
EFFECT_PRESETS = [
    ...
    },
    {
        ...
        "theme_color": None,
        "image_path": None,
        "description": "서비스 창립자에게 수여되는 특별 뱃지",
    },
    {
        "type": "badge",
        ...
        "theme_color": None,
        "image_path": None,
        "description": "커뮤니티에 활발히 기여한 상위 기여자에게 수여",
    },
    {
        "type": "badge",
        "name": "bug_hunter",
        ...
        "theme_color": None,
        "image_path": None,
        "description": "버그 발견 및 리포트에 기여한 사용자에게 수여",
    },
    {
        "type": "badge",
        ...
        "theme_color": None,
        "image_path": None,
        "description": "초기 서비스 기간 동안 성원해 준 사용자에게 수여",
    },
    {
        "type": "badge",
        ...
        "theme_color": None,
        "image_path": None,
        "description": "커뮤니티 지원과 질서 유지에 기여한 사용자에게 수여",
    },
    {
        "type": "badge",
        "name": "event_champion",
        ...
        "theme_color": None,
        "image_path": None,
        "description": "공식 이벤트에서 우수한 성과를 낸 사용자에게 수여",
    },
    {
        "type": "badge",
        "name": "daily_streak",
        ...
        "theme_color": None,
        "image_path": None,
        "description": "연속 출석 등 활동성에 대한 연속 보상 뱃지",
    },
    {
        "type": "badge",
        "name": "cosmetic_collector",
        "price": 0,
        "rarity": "rare",
        "theme_color": None,
        "image_path": None,
        "description": "다양한 코스메틱 아이템을 수집한 사용자에게 수여",
    },
]
