"""
로거 모듈 - apps.common.logger로 이동됨
하위 호환성을 위한 리다이렉션
"""

# 하위 호환성을 위해 apps.common.logger에서 import
from apps.common.logger import Logger, init_logger, get_logger, logger

__all__ = ["Logger", "init_logger", "get_logger", "logger"]

"""
# 이전 코드 (참고용, 실제로는 apps.common.logger를 사용)
