...
class APIEndpoints:
    ...
    def __init__(self, api_version='v1'):
        ...
        if endpoint_env.exists():
            ...
            print(f"✓ Loaded endpoints from: {endpoint_env}")
        else:
            print(f"⚠ Endpoint file not found: {endpoint_env}")
    ...
    def AUTH_IMAGE_UUID(self):
        return self._get_endpoint('AUTH_IMAGE_UUID')
    
    @property
    def AUTH_IMAGE_USER(self):
        return self._get_endpoint('AUTH_IMAGE_USER')
    ...
    @property
    def POST_IMAGE(self):
        return self._get_endpoint('POST_IMAGE')
