...
Revision ID: 0e4c0103f694
Revises: 
Create Date: 2025-10-31 10:58:17.304850
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['location'], ['locations.location_id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], ),
    ...
    sa.UniqueConstraint('content_type', 'object_id', 'mentioned_user_id', name='unique_mention')
    )
