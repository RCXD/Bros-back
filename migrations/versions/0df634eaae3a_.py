...
Revision ID: 0df634eaae3a
Revises: 
Create Date: 2025-11-12 15:32:49.052926
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['mentioner_id'], ['users.user_id'], ondelete='CASCADE'),
    ...
    sa.Column('type', sa.Enum('MENTION', 'POST_LIKE', 'REPLY_LIKE', 'COMMENT', 'FOLLOW', name='notificationtype'), nullable=False),
